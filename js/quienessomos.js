...
const btnFlechaAbajo = document.getElementById('btnFlechaAbajo');
const btnFlechaArriba = document.getElementById('btnFlechaArriba');
...
btnConocenos.addEventListener('click', () => {
    ...
    btnFlechaAbajo.classList.add('d-none');
    btnFlechaArriba.classList.remove('d-none');
});
...
btnFlechaArriba.addEventListener('click', () => {
    ...
    btnFlechaAbajo.classList.remove('d-none');
    btnFlechaArriba.classList.add('d-none');
});